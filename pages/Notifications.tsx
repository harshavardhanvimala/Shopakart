...
interface NotificationItem {
  id: string;
  type: 'DEAL' | 'RESTOCK' | 'MESSAGE' | 'SYSTEM';
  title: string;
  message: string;
  time: string;
  isRead: boolean;
...
const Notifications: React.FC<NotificationsProps> = ({ onBack, onNavigateToShop }) => {
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    {
      id: '1',
      type: 'RESTOCK',
      title: 'Restock Alert',
      message: 'The Daily Grind just restocked "Arabica Roast". Grab it before it’s gone!',
      time: '12m ago',
      isRead: false
    },
    {
      ...
      type: 'DEAL',
      title: 'Flash Deal!',
      message: 'Tech Haven has an exclusive 15% discount for the next 2 hours.',
      time: '1h ago',
      isRead: false
    },
    {
      ...
      message: 'Blue Bottle Coffee replied to your inquiry about outdoor seating.',
      time: '3h ago',
      isRead: true
    },
    {
      id: '4',
      type: 'SYSTEM',
      title: 'Shopakart Plus',
      message: 'Your monthly "Plus" benefits are now active. Check out your new badges.',
      time: '1d ago',
      isRead: true
    }
  ]);
