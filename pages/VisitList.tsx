        ...
        {shopIds.length > 0 ? (
          ...
          <div className="py-20 flex flex-col items-center justify-center text-center animate-in zoom-in duration-700">
            <div className="relative mb-8">
              ...
              <div className="relative w-32 h-32 bg-slate-50 dark:bg-white/5 border-4 border-dashed border-slate-200 dark:border-white/10 rounded-[3rem] flex items-center justify-center text-slate-200 dark:text-white/10">
