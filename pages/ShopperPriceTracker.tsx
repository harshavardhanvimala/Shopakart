  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-obsidian pb-32 animate-in slide-in-from-right transition-colors">
      ...
      <main className="px-6 -mt-6 relative z-10 space-y-6">
        {/* AI Insight Card */}
        <div className="bg-white dark:bg-white/5 p-6 rounded-[32px] border border-indigo-100 dark:border-indigo-500/20 shadow-xl shadow-indigo-500/5">
          <div className="flex items-center gap-2 mb-3">
             <div className="w-8 h-8 bg-indigo-50 dark:bg-indigo-500/10 rounded-xl flex items-center justify-center text-indigo-600">
                <Sparkles size={16} />
             </div>
             <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest">Market Insight</h3>
          </div>
